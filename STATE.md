...
- 🆕 **ARMED 2026-07-11 (weekly-plan session):**
  ...
  - `~/Projects/tag/membership_console_contract_prompt.md` — slut-lane data contract for the Claude-Design membership-console rebuild (spine #195): write `track.membership` enum mix/listen/unclassified on a wip copy; retire the Swift app; fix the pre-#134 pool/iceberg vocab drift. UI = operator lane.
