...
Last updated: **2026-07-12** by hag (v3-kill blocker #3 FEED-half landed: v4-native identity feeder run live + verified, 3 sibling feeders retired/repointed — no brain-feed code reads music_v3.db; RE-KEY half off crosswalk_v3v4_identity still open; spine #247-#253. See KEYSTONE (3).) — prior 2026-07-11 by slut (BEATPORT/SPOTIFY gap-closers RAN on real v4 + §19 provider-ID capture wired into ts-get intake + Spotify FLAC-tag writeback + ts-get/ts-fix --comp compilation force; spine #158-#185 — see top 🟢 block; ISRC classifier FIXED #178; METADATA CORRECTNESS staging #176; fingerprint #180-182; integrity #186)
